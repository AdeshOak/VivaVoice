...
//
        ...
        catch(Exception ex)
        {
          ...
          try { 
            ...
            new PlayAudio().playAudio("/Users/adeshoak/Desktop/BEProj/Interactive-System-For-Product-Purchase-Through-Gesture-and-Voice/botvoice/welcome.mp3");
            ...
            ht.setObject(mf);
            ht.start();
             new PlayAudio().playAudio("/Users/adeshoak/Desktop/BEProj/Interactive-System-For-Product-Purchase-Through-Gesture-and-Voice/botvoice/phone.mp3");
